...
type Slice_NgingFtpUser = factory.Slicex[*NgingFtpUser]
...
func (a *NgingFtpUser) CtxFrom(source factory.Model) factory.Model {
...
func (a *NgingFtpUser) List(recv interface{}, mw func(db.Result) db.Result, page, size int, args ...interface{}) (func() int64, error) {
	...
	if err == nil {
		switch v := recv.(type) {
		case *[]*NgingFtpUser:
			err = a.base.FireReaded(a, queryParam, Slice_NgingFtpUser(*v))
		case []*NgingFtpUser:
			err = a.base.FireReaded(a, queryParam, Slice_NgingFtpUser(v))
		case factory.Ranger:
...
func (a *NgingFtpUser) Clone() *NgingFtpUser {
	cloned := NgingFtpUser{Id: a.Id, Username: a.Username, Password: a.Password, Banned: a.Banned, Directory: a.Directory, Modify: a.Modify, IpWhitelist: a.IpWhitelist, IpBlacklist: a.IpBlacklist, Created: a.Created, Updated: a.Updated, GroupId: a.GroupId}
	cloned.CtxFrom(a)
	return &cloned
}
...
func (a *NgingFtpUser) GetField(field string) interface{} {
	switch field {
	case "Id":
		return a.Id
	case "Username":
...
func (a *NgingFtpUser) GetAllFieldNames() []string {
	return []string{
		"Id",
		"Username",
		"Password",
...
func (a *NgingFtpUser) HasField(field string) bool {
	switch field {
	case "Id":
		return true
	case "Username":
...
func (a *NgingFtpUser) ListPageByOffset(cond *db.Compounds, sorts ...interface{}) error {
	return pagination.ListPageByOffset(a, cond, sorts...)
}

func (a *NgingFtpUser) ListPageByOffsetAs(recv interface{}, cond *db.Compounds, sorts ...interface{}) error {
...
func (a *NgingFtpUser) Validate(column string, value interface{}) error {
	return a.base.Validate(a, column, value)
}

func (a *NgingFtpUser) TrimOverflowText(column string, value string) string {
